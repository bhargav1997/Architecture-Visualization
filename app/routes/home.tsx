            ...
            <div className='section-inner'>
               <div className='section-head'>
                  <div className='copy'>
                     <h2>Projects</h2>
                     <p>
                        Explore stunning architectural designs created with Roomify. From cozy homes to commercial spaces, see how our
                        AI-powered platform transforms ideas into reality.
                     </p>
                  </div>
               </div>
               ...
               <div className='projects-grid'>
                  <div className='project-card group'>
                     ...
                     <div className='card-body'>
                        <div>
                           <h3>Project Manhaten</h3>
                           <div className='meta'>
                              <Clock size={12} />
                              <span>{new Date("01.01.2027").toDateString()}</span>
                              <span>By Bhargav Suthar</span>
                           </div>
                        </div>
